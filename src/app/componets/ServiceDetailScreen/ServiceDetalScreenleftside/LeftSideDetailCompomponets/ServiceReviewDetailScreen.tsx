...
function ServiceReviewDetailScreen() {
  ...
  return (
    <div className="w-full h-auto photoservicedetailborderandshado p-6 rounded-lg">
      {/* Heading */}
      ...
      <div className="w-full flex flex-col gap-6 pt-4">
        ...
        <div className="w-full flex justify-start items-center gap-6">
          ...
          <div className="text-base font-medium font-poppins text-[#000000]">
        ...
        <div className="w-full flex flex-col gap-6">
          {reviewsData.length > 0 ? (
            reviewsData.map((review, idx) => {
              ...
              return (
                <div
                  className="w-full h-auto photoservicedetailborderandshado p-4 rounded-lg relative"
                  id={String(idx)}
                  key={idx}
                >
                    ...
                    <div className="flex gap-3 items-center">
                      <div className="w-12 h-12 rounded-full relative">
                        <Image
                          src={review.image}
                          alt="avatar"
                          className="  rounded-full absolute top-[-1.5rem] left-0"
                          width={80}
                          height={80}
                        />
                      </div>
                      <div className="text-base font-medium absolute left-[12%] top-4 font-poppins text-[#000000]">
                        <span>
